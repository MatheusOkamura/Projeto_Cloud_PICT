  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ibmec-blue-50 to-gray-100 py-8 px-4">
      <div className="container mx-auto max-w-2xl">
        <Card>
          <h2 className="text-2xl font-bold text-ibmec-blue-800 mb-4">Enviar Relatório Parcial</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="label">Arquivo do Relatório Parcial</label>
            ...
            <div className="flex justify-end">
              <button type="submit" disabled={sending} className="btn-primary">
                {sending ? 'Enviando...' : 'Enviar Relatório Parcial'}
              </button>
            </div>
          </form>
        </Card>
